...
showWindow(){this.loadBtn.classList.add('disabled');this.bodySelector.style.height='100vh';this.bodySelector.style.overflow='hidden';this.mainSection.style.height='100vh';this.mainSection.style.overflow='hidden';this.tableWindow.style.display='flex';this.createTable();}
