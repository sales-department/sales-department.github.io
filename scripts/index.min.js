...
showWindow(){this.bodySelector.style.height='100vh';this.bodySelector.style.overflow='hidden';this.mainSection.style.height='100vh';this.mainSection.style.overflow='hidden';this.tableWindow.style.display='flex';this.createTable();}
closeWindow(){this.bodySelector.style.height='100%';this.bodySelector.style.overflow='';this.mainSection.style.height='100%';this.mainSection.style.overflow='';this.tableWindow.style.display='none';}
