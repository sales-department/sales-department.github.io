...
return result;}
find=(findElem(searchInput,this.findTempArr));if(find=='-1'){find=[];for(let i=0;i<this.findTempArr.length;i++){if(this.findTempArr[i].Name.toLowerCase().includes(searchInput)){find.push(this.findTempArr[i]);}}
