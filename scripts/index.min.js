...
init(){let date=new Date();let checkUpdate=localStorage.getItem('update');if(checkUpdate==1){let str=`Обновлено ${date.getDate()}.${date.getMonth()}.${date.getFullYear()} в ${date.getHours()}:${date.getMinutes()}`;this.updatedInfo.append(str);this.updatedInfo.style.display='block';localStorage.setItem('update','0');}
