...
logIn(){this.loginBtn.classList.add('disabled');this.loginWindow.style.display='flex';setTimeout(()=>{this.loginWindow.style.opacity='1';this.body.style.overflow='hidden';},200)}
...
reject(){this.loginWindow.style.opacity='0';this.body.style.overflow='';setTimeout(()=>{this.loginBtn.classList.remove('disabled');this.loginWindow.style.display='none';this.loginWindowInput.value='';M.updateTextFields();},200)}}
...
this.removeDisabledBtns();this.search.value='';this.isCollapse();let checkLogin=localStorage.getItem('auth');if(checkLogin=='1')$('.collapsible').collapsible();},100);}
